...
Plugin URI: https://wordpress.org/plugins/ts-webfonts-for-onamae/
...
class TypeSquare_ST
{
    ...
    public function load_scripts()
    {
        ...
        if (false !== $uid) {
            wp_register_script('typesquare_std', "//code.typesquare.com/static/ZDbTe4IzCko%253D/ts307f.js?$query", array( 'jquery' ), $version, false);
