    ...
    class MakeMainColumnStyle{
        ...
        public static function Value(){
            ...
            if($CustomizeMainColumn->SetNewestArticleAreaThumBorder == "true"){
                $CssNolimit .= '
                .contentarea .NewestArticlelinkarea .ThumbArea img, .contentarea .NewestArticlelinkarea .ThumbArea .dummy{
                    border: solid '.$CustomizeMainColumn->SetNewestArticleAreaThumbBorderColor.' 0.5px;
                }';
            }
            if($CustomizeMainColumn->SetCategoryArticleThumbBorder == "true"){
                $CssNolimit .= '
                .contentarea .Catlinkarea .ThumbArea img, .contentarea .Catlinkarea .ThumbArea .dummy{
            ...
            if($CustomizeMainColumn->SetPopularArticleAreaThumBorder == "true"){
                $CssNolimit .= '
                .contentarea .PopularArticleArealinkarea .ThumbArea img, .contentarea .PopularArticleArealinkarea .ThumbArea .dummy{
