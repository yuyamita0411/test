...
window.addEventListener('DOMContentLoaded', () => {
    ['load', 'resize'].forEach((ev) => {
        window.addEventListener(ev, () => {
            ...
            contentmargin += document.getElementById('gnavlinkarea') ? document.getElementById('gnavlinkarea').offsetHeight : 0;
            ...
            topmargin += document.getElementById('gnavlinkarea') ? document.getElementById('gnavlinkarea').offsetHeight : 0;
