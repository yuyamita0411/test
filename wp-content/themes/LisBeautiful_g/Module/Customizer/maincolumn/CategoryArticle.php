    ...
    class CustomizeMainColumnCategoryArticle{
                ...
                'mainbackground' => array(
                    ...
                    'CatATDControll' => array(
                        ...
                        'choices'     =>  array(
                            ...
                            'pt4'   => __( $lng["vals"]["CustomizeMainColumnCategoryArticle"]["CatATDControll"]["choices"]["pt4"] ),
                            'pt5'   => __( $lng["vals"]["CustomizeMainColumnCategoryArticle"]["CatATDControll"]["choices"]["pt5"] ),
                            'pt6'   => __( $lng["vals"]["CustomizeMainColumnCategoryArticle"]["CatATDControll"]["choices"]["pt6"] ),
                            'pt7'   => __( $lng["vals"]["CustomizeMainColumnCategoryArticle"]["CatATDControll"]["choices"]["pt7"] ),
                            'pt8'   => __( $lng["vals"]["CustomizeMainColumnCategoryArticle"]["CatATDControll"]["choices"]["pt8"] ),
                            'pt9'   => __( $lng["vals"]["CustomizeMainColumnCategoryArticle"]["CatATDControll"]["choices"]["pt9"] ),
        ...
        public static function Values(){
            return (object)[
                ...
                'SetCategoryArticleThumbBorder' => !get_theme_mod('CD_CatAThBDSetting') ? 'true' : get_theme_mod('CD_CatAThBDSetting'),
