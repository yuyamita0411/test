    ...
    class CustomizeMainColumnPopularArticleArea{
                ...
                'mainbackground' => array(
                    ...
                    'PArTDControll' => array(
                        ...
                        'choices'     =>  array(
                            ...
                            'pt4'   => __( $lng["vals"]["CustomizeMainColumnPopularArticleArea"]["PArTDControll"]["choices"]["pt4"] ),
                            'pt5'   => __( $lng["vals"]["CustomizeMainColumnPopularArticleArea"]["PArTDControll"]["choices"]["pt5"] ),
                            'pt6'   => __( $lng["vals"]["CustomizeMainColumnPopularArticleArea"]["PArTDControll"]["choices"]["pt6"] ),
                            'pt7'   => __( $lng["vals"]["CustomizeMainColumnPopularArticleArea"]["PArTDControll"]["choices"]["pt7"] ),
                            'pt8'   => __( $lng["vals"]["CustomizeMainColumnPopularArticleArea"]["PArTDControll"]["choices"]["pt8"] ),
                            'pt9'   => __( $lng["vals"]["CustomizeMainColumnPopularArticleArea"]["PArTDControll"]["choices"]["pt9"] ),
        ...
        public static function Values(){
            return (object)[
                ...
                'SetPopularArticleAreaThumBorder' => !get_theme_mod('CD_PArThBDSetting') ? 'true' : get_theme_mod('CD_PArThBDSetting'),
