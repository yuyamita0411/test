                ...
                'sidecolumntemplate' => array(
                    ...
                    'SCCatLDControll' => array(
                        ...
                        'choices'     =>  array(
                            ...
                            'pt4'   => __( $lng["vals"]["CustomizeSideColumnCategoryLink"]["SCCatLDControll"]["choices"]["pt4"] ),
                            'pt5'   => __( $lng["vals"]["CustomizeSideColumnCategoryLink"]["SCCatLDControll"]["choices"]["pt5"] ),
                            'pt6'   => __( $lng["vals"]["CustomizeSideColumnCategoryLink"]["SCCatLDControll"]["choices"]["pt6"] ),
                            'pt7'   => __( $lng["vals"]["CustomizeSideColumnCategoryLink"]["SCCatLDControll"]["choices"]["pt7"] ),
                            'pt8'   => __( $lng["vals"]["CustomizeSideColumnCategoryLink"]["SCCatLDControll"]["choices"]["pt8"] ),
                            'pt9'   => __( $lng["vals"]["CustomizeSideColumnCategoryLink"]["SCCatLDControll"]["choices"]["pt9"] ),
                        )
                    ),
                    //カテゴリ一覧全体の余白
