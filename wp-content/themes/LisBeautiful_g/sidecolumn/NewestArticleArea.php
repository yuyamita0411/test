...
$query = SubQuery::NewestArticleArea(CustomizeSideColumn::Values()->NewestArticleAreaNumber);
?>
<nav class="NewestArticleNav d-inline-block w-100 float-left">
    <div id="" class="w-100 d-inline-block float-left">
        <div class="NewestArticleTitleWrapper w-100 d-inline-block float-left">
            <div class="NewestArticleTitleArea float-left w-100 d-inline-block">
                <div id="" class="NewestArticleAreaFontTop w-100 mb-0">
                    <p id="" class="NewestArticleAreaFontTopInner mb-0 d-inline-block">
                        <?php echo CustomizeSideColumn::Values()->NewestArticleAreaTitle;?>
                    </p>
                </div>
                <div id="" class="NewestArticleAreaFontBottom w-100 font-weight-bold mb-0">
                    <h5 id="" class="NewestArticleAreaFontBottomInner mb-0 d-inline-block"><?php echo CustomizeSideColumn::Values()->NewestArticleAreaBottomTitle;?></h5>
                </div>
            </div>
        </div>
        <?php foreach ( $query as $post ) : setup_postdata( $post ); ?>
        <div class="NewestArticlelinkarea float-left w-100">
