...
$notfound_image = get_template_directory_uri() . '/library/images/notfound.jpg';
...
<article class="notfound">
  ...
  <div class="nofound-img"><img src="<?php echo apply_filters('sng_notfound_image', $notfound_image) ?>">
    <?php if (is_404()) { ?> 
