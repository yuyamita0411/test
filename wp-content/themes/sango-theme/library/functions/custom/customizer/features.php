 ...
 * SANGOのオリジナル機能
 *********************/
App::get('customizer_builder')->addSection('💻 SANGOオリジナル機能', 'sango_original_addon', [
  'priority' => 53
]);
// タブ
App::get('customizer_builder')->addSection('記事一覧タブ切替（トップページ）', 'sng_tab', [
  'priority' => 1,
  'parent' => 'sango_original_addon'
]);
App::get('customizer_builder')->addConfig('sng_tab', [
  'name' => 'activate_tab',
  'updateMethod' => 'option',
...
// モバイルフッター固定メニュー
App::get('customizer_builder')->addSection('モバイルフッター固定メニュー', 'footer_fixed', [
  'priority' => 2,
  'parent' => 'sango_original_addon',
...
App::get('customizer_builder')->addConfig('footer_fixed', [
...
// ヘッダーお知らせ欄
App::get('customizer_builder')->addSection('ヘッダーお知らせ欄', 'header_info', [
  'priority' => 3,
  'parent' => 'sango_original_addon',
]);
App::get('customizer_builder')->addConfig('header_info', [
...
// フォローボックス（記事下）
App::get('customizer_builder')->addSection('フォローボックス（記事下）', 'show_like_box', [
  'priority' => 4,
  'parent' => 'sango_original_addon'
]);

App::get('customizer_builder')->addConfig('show_like_box', [
...
// 関連記事（記事下）
App::get('customizer_builder')->addSection('関連記事（記事下）', 'sng_related_posts', [
  'priority' => 5,
  'parent' => 'sango_original_addon'
]);
App::get('customizer_builder')->addConfig('sng_related_posts', [
...
// おすすめ記事（記事下）
App::get('customizer_builder')->addSection('おすすめ記事（記事下）', 'recommended_posts', [
  'priority' => 6,
  'parent' => 'sango_original_addon'
]);
App::get('customizer_builder')->addConfig('recommended_posts', [
...
// CTA（記事下）
App::get('customizer_builder')->addSection('CTA（記事下）', 'show_cta', [
  'priority' => 7,
  'parent' => 'sango_original_addon'
]);
App::get('customizer_builder')->addConfig('show_cta', [
  'name' => 'enable_cta',
  'updateMethod' => 'option',
  'type' => 'checkbox',
  'title' => 'CTAを記事下に表示する',
...
App::get('customizer_builder')->addSection('トップへ戻るボタン', 'to_top', [
  'priority' => 8,
  'parent' => 'sango_original_addon'
]);
App::get('customizer_builder')->addConfig('to_top', [
  'name' => 'show_to_top',
  'type' => 'checkbox',
  'updateMethod' => 'option',
...
// シェアボタン設定
App::get('customizer_builder')->addSection('シェアボタンの設定', 'sng_share_setting', [
  'priority' => 9,
  'parent' => 'sango_original_addon'
]);
App::get('customizer_builder')->addConfig('sng_share_setting', [
  'name' => 'another_social',
  'type' => 'checkbox',
  'updateMethod' => 'option',
