 ...
 * ヘッダーアイキャッチ
 *********************/
App::get('customizer_builder')->addSection('🏞 ヘッダーアイキャッチ', 'panel_featured_header', [
  'priority' => 55
]);
// ヘッダーアイキャッチ
App::get('customizer_builder')->addSection('ヘッダーアイキャッチ画像', 'header_image', [
  'priority' => 1,
  'transport' => 'postMessage',
  'parent' => 'panel_featured_header'
]);
App::get('customizer_builder')->addConfig('header_image', [
...
// 2分割ヘッダーアイキャッチ
App::get('customizer_builder')->addSection('2分割ヘッダーアイキャッチ画像', 'header_divide_image', [
  'priority' => 2,
  'transport' => 'postMessage',
  'parent' => 'panel_featured_header'
]);
App::get('customizer_builder')->addConfig('header_divide_image', [
