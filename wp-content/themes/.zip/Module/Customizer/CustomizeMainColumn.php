<?php
    class CustomizeMainColumn{
        ...
        public function SetMenuStatus( $wp_customize ) {
            $settings = array(
                'mainbackground' => array(
                    ...
                    'ADcontroll' => array(
                        ...
                        'section'     => 'AD_section', 
                        'settings'    => 'AD_setting', 
                        'default'   => 'profile-box-pt1 d-inline-block',
                        'choices'     =>  array(
                            'profile-box-pt1 d-inline-block'   => __( 'パターン1' ),
                            'profile-box-pt2 d-inline-block'   => __( 'パターン2' ),
                            'profile-box-pt3 d-inline-block'   => __( 'パターン3' ),
                            'd-none'   => __( '非表示' )
                        )
                    ),
                    'SNSTDcontroll' => array(
            ...
            $wp_customize->add_setting($settings['mainbackground']['ADsetting'], $settings['mainbackground']['ADdefault']);
            ...
            $wp_customize->add_control(new WP_Customize_Control( $wp_customize, 'AD_setting', $settings['mainbackground']['ADcontroll']));
        ...
        public static function Values(){
            ...
            return (object)[
                'DisplayAuthor' => !get_theme_mod('AD_setting') ? 'profile-box-pt1 d-inline-block' : get_theme_mod('AD_setting'),
                ...
                'SetNewestArticleAreaThumBorder' => !get_theme_mod('CD_CatAThBDSetting') ? 'true' : get_theme_mod('CD_CatAThBDSetting'),
