    ...
    class CustomizeAuthorInfo{
        ...
        public static function Values(){
            return (object)[
                ...
                'AuthoInfoOutLineColor' => !get_theme_mod('AInfoOLClSetting') ? 'rgb(233, 236, 239)' : get_theme_mod('AInfoOLClSetting'),//外枠の色調整 ok
                ...
                'AuthoInfoTitleOutlineColor' => !get_theme_mod('AInfoTAlCSetting') ? 'rgb(233, 236, 239)' : get_theme_mod('AInfoTAlCSetting'),//タイトル枠線色 ok
                ...
                'AuthoInfoNameOutlineColor' => !get_theme_mod('AInfoFAlCSetting') ? 'rgb(233, 236, 239)' : get_theme_mod('AInfoFAlCSetting'),//名前枠線色 ok
